...
public class Group
{
    ...
    private double noise;			  //density of noise
    private int[][] influenceArray;   //array for external influence
    private double influencePlus;	  //density of PLUS influence
    private double influenceMinus;	  //density of minus influence
    int plus; int minus;
    /*************************************************************************/

    //Constructor of Majority class
    public Group(int size, int iterations, double density, int seed, double noise, double influencePlus, double influenceMinus)
    {
