...
public class Majority
{
    ...
    private double influence;		  //amount of influence on majority opinion
    
    int plus; int minus;
    /*************************************************************************/

    //Constructor of Majority class
    public Majority(int size, int iterations, double density, int seed, double noise, double influence)
    {
